...
class BoxRepo{
  ...
  BoxRepo({ required this.apiClient,required this.sharedPreferences});





  Future<Response>  openBox(int id,userId) async{
    return await apiClient.postData(Constants.OPEN_BOX_POST_URI,{"id":id,"userId":userId});
  }
