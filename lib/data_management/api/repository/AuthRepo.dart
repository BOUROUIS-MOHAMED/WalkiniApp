...
/*  Future<Response>  uploadProfileImage(File image,String name) async{

    return await apiClient.uploadImage(image,"94970082","http://192.168.1.8:5000/api/v1/file/uploadProfileImageToFileSystem");
  }*/
...
Future<Response>  registrationOfNormalUser(NormalUserModel normalUserModel) async{
 return await apiClient.postData(Constants.REGISTRATION_NORMAL_USER_POST_URI, normalUserModel.toJson());
}
